...
from databricks.koalas.internal import InternalFrame, NATURAL_ORDER_COLUMN_NAME, SERIES_DEFAULT_NAME
    ...
    def __setitem__(self, key, value):
        ...
        if self._is_series:
            ...
            scol = (
                ...
                .alias(name_like_string(self._kdf_or_kser.name or SERIES_DEFAULT_NAME))
            )
    ...
    def __setitem__(self, key, value):
        ...
        if self._is_series:
            ...
            internal = internal.copy(
                spark_frame=sdf,
                column_labels=[internal.column_labels[0] or (SERIES_DEFAULT_NAME,)],
