...
class _MissingPandasLikeSeries(object):
    ...
    count = unsupported_function('count')
    ...
    kurt = unsupported_function('kurt')
    kurtosis = unsupported_function('kurtosis')
    ...
    mean = unsupported_function('mean')
    ...
    skew = unsupported_function('skew')
