...
class _MissingPandasLikeDataFrame(object):
    ...
    apply = unsupported_function('apply', deprecated=True)
    ...
    mask = unsupported_function('mask', deprecated=True)
    reindex_axis = unsupported_function('reindex_axis', deprecated=True)
    resample = unsupported_function('resample', deprecated=True)
    ...
    to_records = unsupported_function('to_records', deprecated=True)
