...
class _MissingPandasLikeIndex(object):
    ...
    is_boolean = common.is_boolean(unsupported_function)
    is_categorical = common.is_categorical(unsupported_function)
    is_floating = common.is_floating(unsupported_function)
    is_integer = common.is_integer(unsupported_function)
    is_interval = common.is_interval(unsupported_function)
    is_numeric = common.is_numeric(unsupported_function)
    is_object = common.is_object(unsupported_function)
