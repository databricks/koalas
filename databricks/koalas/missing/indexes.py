...
class _MissingPandasLikeMultiIndex(object):
    ...
    argsort = unsupported_function('argsort', deprecated=True)
    asof = unsupported_function('asof', deprecated=True)
    asof_locs = unsupported_function('asof_locs', deprecated=True)
    delete = unsupported_function('delete', deprecated=True)
    difference = unsupported_function('difference', deprecated=True)
    drop = unsupported_function('drop', deprecated=True)
    duplicated = unsupported_function('duplicated', deprecated=True)
    equal_levels = unsupported_function('equal_levels', deprecated=True)
    equals = unsupported_function('equals', deprecated=True)
    factorize = unsupported_function('factorize', deprecated=True)
    format = unsupported_function('format', deprecated=True)
    get_indexer_for = unsupported_function('get_indexer_for', deprecated=True)
    get_indexer_non_unique = unsupported_function('get_indexer_non_unique', deprecated=True)
    get_slice_bound = unsupported_function('get_slice_bound', deprecated=True)
    get_value = unsupported_function('get_value', deprecated=True)
    groupby = unsupported_function('groupby', deprecated=True)
    holds_integer = unsupported_function('holds_integer', deprecated=True)
    identical = unsupported_function('identical', deprecated=True)
    insert = unsupported_function('insert', deprecated=True)
    intersection = unsupported_function('intersection', deprecated=True)
    is_ = unsupported_function('is_', deprecated=True)
    is_lexsorted_for_tuple = unsupported_function('is_lexsorted_for_tuple', deprecated=True)
    is_mixed = unsupported_function('is_mixed', deprecated=True)
    is_type_compatible = unsupported_function('is_type_compatible', deprecated=True)
    join = unsupported_function('join', deprecated=True)
    map = unsupported_function('map', deprecated=True)
    nunique = unsupported_function('nunique', deprecated=True)
    putmask = unsupported_function('putmask', deprecated=True)
    ravel = unsupported_function('ravel', deprecated=True)
    reindex = unsupported_function('reindex', deprecated=True)
    repeat = unsupported_function('repeat', deprecated=True)
    searchsorted = unsupported_function('searchsorted', deprecated=True)
    set_labels = unsupported_function('set_labels', deprecated=True)
    set_names = unsupported_function('set_names', deprecated=True)
    slice_indexer = unsupported_function('slice_indexer', deprecated=True)
    slice_locs = unsupported_function('slice_locs', deprecated=True)
    sort_values = unsupported_function('sort_values', deprecated=True)
    take = unsupported_function('take', deprecated=True)
    to_native_types = unsupported_function('to_native_types', deprecated=True)
    truncate = unsupported_function('truncate', deprecated=True)
    union = unsupported_function('union', deprecated=True)
    view = unsupported_function('view', deprecated=True)
