...
class DatetimeMethods(object):
    ...
    def __init__(self, series: "ks.Series"):
        if not isinstance(series.spark_type, (DateType, TimestampType)):
            raise ValueError(
                "Cannot call DatetimeMethods on type {}".format(series.spark_type)
            )
        self._data = series
    ...
    def is_month_start(self) -> "ks.Series":
        ...
        """
        return _wrap_accessor_pandas(
            self, lambda s: s.dt.is_month_start, BooleanType()
    ...
    def is_month_end(self) -> "ks.Series":
        ...
        """
        return _wrap_accessor_pandas(
            self, lambda s: s.dt.is_month_end, BooleanType()
        ).alias(self._data.name)
    ...
    def is_quarter_start(self) -> "ks.Series":
        ...
        """
        return _wrap_accessor_pandas(
            self, lambda s: s.dt.is_quarter_start, BooleanType()
        ).alias(self._data.name)
    ...
    def is_quarter_end(self) -> "ks.Series":
        ...
        """
        return _wrap_accessor_pandas(
            self, lambda s: s.dt.is_quarter_end, BooleanType()
        ).alias(self._data.name)
    ...
    def is_year_start(self) -> "ks.Series":
        ...
        """
        return _wrap_accessor_pandas(
            self, lambda s: s.dt.is_year_start, BooleanType()
        ).alias(self._data.name)
    ...
    def is_year_end(self) -> "ks.Series":
        ...
        """
        return _wrap_accessor_pandas(
            self, lambda s: s.dt.is_year_end, BooleanType()
        ).alias(self._data.name)
    ...
    def daysinmonth(self) -> "ks.Series":
        ...
        """
        return _wrap_accessor_pandas(
            self, lambda s: s.dt.daysinmonth, LongType()
        ).alias(self._data.name)
    ...
    def normalize(self) -> "ks.Series":
        ...
        """
        return _wrap_accessor_pandas(
            self, lambda x: x.dt.normalize(), TimestampType()
        ).alias(self.name)
    ...
    def floor(self, freq, *args, **kwargs) -> "ks.Series":
        ...
        """
        return _wrap_accessor_pandas(
            self, lambda x: x.dt.floor(freq), TimestampType()
        ).alias(self.name)
    ...
    def ceil(self, freq, *args, **kwargs) -> "ks.Series":
        ...
        """
        return _wrap_accessor_pandas(
            self, lambda x: x.dt.ceil(freq), TimestampType()
        ).alias(self.name)
    ...
    def month_name(self, locale=None) -> "ks.Series":
        ...
        """
        return _wrap_accessor_pandas(
            self, lambda x: x.dt.month_name(locale), StringType()
        ).alias(self.name)
    ...
    def day_name(self, locale=None) -> "ks.Series":
        ...
        """
        return _wrap_accessor_pandas(
            self, lambda x: x.dt.day_name(locale), StringType()
        ).alias(self.name)
