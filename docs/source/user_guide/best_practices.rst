...
The list of unsupported APIs
----------------------------

Koalas does not support several APIs that may cause memory issues mostly due to the size of the data.

- list of API not supported for DataFrame
    - DataFrame.values
    - DataFrame.to_pickle
    - DataFrame.memory_usage
    - DataFrame.to_xarray

- list of API not supported for Series
    - Series.values
    - Series.to_pickle
    - Series.memory_usage
    - Series.to_xarray
...
- list of API not supported for Index & MultiIndex
    - Index.values
    - Index.memory_usage
    - Index.array
    - Index.duplicated
